...
+(function ($) {
  ...
  OffCanvas.prototype.disableScrolling = function () {
    ...
    $("body").on("touchmove.bs", function (e) {
      if (!$(event.target).closest(".offcanvas").length) e.preventDefault();
    });
  };
    ...
    this.hideOthers(
      $.proxy(function () {
        ...
        elements.addClass("canvas-sliding").each(function () {
          ...
          if (
            ($this.css(placement) === "auto" || $this.css(placement) === "0px") &&
  ...
  OffCanvas.prototype.toggleBackdrop = function (callback) {
    ...
    if (this.state == "slide-in") {
      ...
      doAnimate ? this.$backdrop.one($.support.transition.end, callback).emulateTransitionEnd(time) : callback();
  ...
  OffCanvas.prototype.calcClone = function () {
    ...
    if (!this.$calcClone.length) {
      this.$calcClone = this.$element.clone().addClass("offcanvas-clone").attr("data-id", id).removeAttr("id").appendTo($("body")).html("");
    }
...
+(function ($) {
  ...
  (Fileinput.prototype.change = function (e) {
    ...
    if (
      ...
      (typeof file.type !== "undefined" ? file.type.match(/^image\/(gif|png|jpeg|svg\+xml)$/) : file.name.match(/\.(gif|png|jpe?g|svg)$/i)) &&
